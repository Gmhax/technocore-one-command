...
import { createTechnocoreRouter } from "./technocore.js";
...
app.use(originGuard);
app.use("/api", createTechnocoreRouter());
app.use(
...
function printStartup(port: number): void {
  console.log("");
  console.log("Technocore Live Workstream running");
  console.log("");
...
/**
 * The server is meant to run on the viewer's own machine. Refusing
 * cross-origin requests keeps another site from driving it as an open relay to
 * the upstream host.
 */
